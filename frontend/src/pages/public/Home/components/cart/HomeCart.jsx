  ...
  return (
    <Sheet open={open} onOpenChange={(v) => !v && onClose()}>
      ...
      >
        ...
        {/* Footer */}
        {items.length > 0 && (
          <SheetFooter className="px-5 pt-4 pb-6 border-t border-rose-50 flex flex-col gap-3">
            {/* Total */}
            <div className="flex items-center justify-between w-full">
              <span className="text-sm text-rose-400 font-medium">Total</span>
            ...
            {/* Botón compra normal */}
            <button className="w-full h-11 rounded-lg flex items-center justify-center gap-2.5 bg-rose-500 hover:bg-rose-600 active:bg-rose-700 text-white text-[11px] font-bold tracking-widest uppercase transition-colors">
              <ShoppingBag size={15} />
              Proceder al pago
            </button>
            ...
            <button
              ...
              className="w-full h-11 rounded-lg flex items-center justify-center gap-2.5 text-white text-[11px] font-bold tracking-widest uppercase transition-colors"
            ...
            <p className="text-center text-[10px] text-rose-300">
              WhatsApp enviará el detalle de tu pedido a la tienda
            </p>
          </SheetFooter>
        )}
      </SheetContent>
