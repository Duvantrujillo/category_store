...
export default function CategoryDetailDialog({ item }) {
        ...
        <DialogContent className="sm:max-w-md rounded-2xl">
          ...
          <div className="flex flex-col gap-4 pt-1">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div className="flex flex-col gap-0.5">
                <span className="text-[11px] text-slate-400 uppercase tracking-wide font-medium">Categoría padre</span>
                <span className="text-slate-600">{item.parent?.name || "—"}</span>
              </div>
