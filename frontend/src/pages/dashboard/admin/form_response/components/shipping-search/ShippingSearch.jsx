...
function ShippingSearch({
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      <div className="flex items-center gap-2 h-8 bg-white border border-slate-200 rounded-xl shadow-sm px-3 transition-all focus-within:border-indigo-300 focus-within:shadow-md focus-within:shadow-indigo-100/60 min-w-60">
      ...
      {loading && (
        <span className="text-xs text-slate-400 whitespace-nowrap ml-1">Buscando...</span>
      )}
