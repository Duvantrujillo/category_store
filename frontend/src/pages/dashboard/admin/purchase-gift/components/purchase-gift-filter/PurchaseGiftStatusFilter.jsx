const OPTIONS = [
  ...
  { value: "paused",    label: "Pausado",    base: "bg-amber-50 text-amber-700 border-amber-200",    on: "bg-amber-600 text-white border-amber-600" },
...
export default function PurchaseGiftStatusFilter({ value, onChange }) {
  return (
