  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-xs text-muted-foreground">Logo de la marca y texto descriptivo.</p>
      </div>
          ...
          {previewSrc ? (
            ...
            >
              ...
              <Button
                ...
                onClick={() => { handleChange("logo", null); handleChange("preview", null); }}
              >
                <X size={13} />
              </Button>
            </div>
            ...
            >
              ...
              <div className="text-center">
                <p className="text-sm font-medium text-slate-600">
                  {isDragActive ? "Suelta el archivo aquí" : "Arrastra el logo aquí"}
                </p>
                <p className="text-xs text-muted-foreground mt-0.5">o haz clic para seleccionarlo</p>
              </div>
            </div>
          )}
